...
# This has the modified new json path which includes the unknown class 
from dataset_test import CTDataset #,image_path
from model import CustomResNet18
import matplotlib.pyplot as plt
import numpy as np

def create_dataloader(cfg, split='train2'):
    '''
...
def main():
    ...
    dl_train = create_dataloader(cfg, split='train2') # was just train before, or upsampling
    ...
    dl_val = create_dataloader(cfg, split='val2')
