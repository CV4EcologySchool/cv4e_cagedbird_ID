...
json_file_path = '/home/sicily/cv4e_cagedbird_ID/data/high/training.json'
...
plt.ylabel("Counts")
plt.title("Distribution of images across species classes for training data")
plt.xticks(rotation=45, ha="right")
plt.tight_layout()

plt.savefig('training_data_categories.png')